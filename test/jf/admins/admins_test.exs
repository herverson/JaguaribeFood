defmodule Jf.AdminsTest do
  ...
  describe "admins" do
    ...
    @valid_attrs %{nome: "some nome", senha: "some senha", username: "some username"}
    ...
    test "create_admin/1 with valid data creates a admin" do
      ...
      assert admin.nome == "some nome"
      assert admin.senha == "some senha"
    ...
    test "update_admin/2 with valid data updates the admin" do
      ...
      assert %Admin{} = admin
      assert admin.nome == "some updated nome"
      assert admin.senha == "some updated senha"
